...
public class ObstacleGame extends JPanel implements ActionListener, KeyListener {
    ...
    private Enemy[] enemies = new Enemy[8]; //the array of Enemy objects
    ...
    public void setUpGame() {
        ...
        enemies[0] = new VerticalEnemy(100, 250, 50, 50, gameHeight, 5);
        enemies[1] = new DiagonalEnemy(300, 300, 50, 50, gameHeight, 5, gameWidth, 6);
        enemies[2] = new StalkerEnemy(100, 200, 50, 50, player);
        enemies[3] = new StalkerEnemy(300, 300, 25, 25, player);
        enemies[4] = new StalkerEnemy(400, 400, 25, 25, player);
        enemies[5] = new SpinningEnemy(450, 400, 50, 50, 100);
        enemies[6] = new DiagonalEnemy(500, 250, 25, 25, gameHeight, 15, gameWidth, 15);
        enemies[7] = new DiagonalEnemy(200, 200, 25, 25, gameHeight, 15, gameWidth, 15);
    }
    ...
    public Image getImage(){
     return ImageLoader.loadCompatibleImage("earth.png");
    }
    ...
    public void paint(Graphics g) {
        ...
        //g.setColor(getColor()); || Bad Idea, eyes hurt
